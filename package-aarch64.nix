...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "https://github.com/imputnet/helium-linux/releases/download/${finalAttrs.version}/helium-bin_${finalAttrs.version}-1_arm64.deb";
    hash = "sha256:163d4a710f59463b402da9085908f11406315cadd03588fb7c9d86c04f8dabf1";
  };
